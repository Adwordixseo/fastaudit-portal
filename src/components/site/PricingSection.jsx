    ...
    <section id="pricing" className="bg-slate-50 py-24">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 text-4xl font-bold text-slate-900 sm:text-5xl">Start for Free & Choose the Right Plan to Succeed</h2>
          <p className="mt-4 text-slate-500">You can access website audit services and more on one dashboard with our subscription-based website audit packages.</p>
