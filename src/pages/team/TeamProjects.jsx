      ...
      <div className="grid gap-6 lg:grid-cols-[340px_1fr]">
        ...
        {selected ? (
          <div className="space-y-5">
            ...
            <ProjectKeywordRankings project={selected} />
                ...
                {sdocs.length === 0 ? (
                  ...
                  <div key={d.id} className="flex items-center justify-between gap-3 rounded-2xl border border-slate-100 bg-slate-50/50 px-4 py-3">
                    ...
                    <div className="flex shrink-0 items-center gap-2">
                      {d.status === 'changes_requested' && deriveChangeRequestStatus(d) === 'pending' && <Button size="sm" variant="outline" className="rounded-full border-blue-200 text-blue-600 hover:bg-blue-50" onClick={() => startReview(d)}>Start review</Button>}
